(() => {
  ...
  const elements = {
    ...
    authMessage: $("#auth-message"), authSwitch: $("#auth-switch"), authSwitchCopy: $("#auth-switch-copy"),
  ...
  async function handleAuth(event) {
    ...
    if (authMode === "signup" && !result.data.session) elements.authMessage.textContent = "Check your email, then follow the confirmation link.";
  }
